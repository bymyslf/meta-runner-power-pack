...
.\GitVersion.ps1 -workingDir "$scriptpath\..\" -output json -logFile "$scriptpath\log.txt" -outputFile "$scriptpath\json.txt" -nocache "true" -updateGitVersion "true" -includePrerelease "true"
